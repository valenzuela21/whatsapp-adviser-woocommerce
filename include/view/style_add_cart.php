...
class style_AddCart
{
    static public function view_add_cart($id_product)
    {
        global $product;
        ...
        foreach ($attributes as $attribute_name => $options) :
            ...
            $count++;
        endforeach;
        echo " <div id='clean-attributes'><button id='clean-attribute' class='clean-reset'>
               <i class='icon-trash-adv'></i>Limpiar</button></div>
               <input type='number' min='1' max='30' value='1' id='number_wc_product' class='number-input-wc' />
               ";
        echo "<div id='button_payment_answer'><button  class='btn-cotiza single_add_to_cart_button'>".__('Agregar Carrito', 'woocommerce')."</button></div>";
        echo "</div>";
        ...
        echo'<div id="input-file-adv"></div>';
            ...
            echo "<div><input type='hidden' value='$id_product'  name='id_product' id='id_product' />
              <input type='number' min='1' max='30' value='1' id='number_wc_product' class='number-input-wc-simple' />";
            echo "<button  class='btn-cotiza single_product_add_to_cart_button'>".__('Agregar Carrito', 'woocommerce')."</button>";
            echo "</div>";
            echo '<div id="adv-whatsapp-adviser"></div>';
            echo '<div class="loader-adviser">
                        <div class="lds-ripple-loader">
